...
<div class="swiper-tabs position-absolute top-0 start-0 w-100 h-100 bg-gradient-dark-translucent">
    <div id="image-1" class="position-absolute top-0 start-0 w-100 h-100 bg-position-center bg-repeat-0 bg-size-cover swiper-tab active" style="background-image: {{ asset ('../../../public/img/logo.png') }};">
        <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-35"></span>
    </div>
    <div id="image-2" class="position-absolute top-0 start-0 w-100 h-100 bg-position-center bg-repeat-0 bg-size-cover swiper-tab" style="background-image: {{ asset ('../../../public/img/logo.png') }};">
        <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-35"></span>
    </div>
    <div id="image-3" class="position-absolute top-0 start-0 w-100 h-100 bg-position-center bg-repeat-0 bg-size-cover swiper-tab" style="background-image: {{ asset ('../../../public/img/logo.png') }};">
        <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-35"></span>
    </div>
</div>
...
<div class="container d-flex flex-column flex-sm-row align-items-center justify-content-between position-relative zindex-5 pb-5">
    ...
    <link href="../../../public/assets/vendor/swiper/swiper-bundle.min.js"/>
    <link href="../../../public/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js">
    <link href="../../../public/assets/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js">
    <link href="../../../public/assets/vendor/jarallax/dist/jarallax.min.js">
    <link href="../../../public/assets/vendor/swiper/swiper-bundle.min.js">
    <link href="../../../public/assets/vendor/lightgallery.js/dist/js/lightgallery.min.js">
    <link href="../../../public/assets/vendor/lg-fullscreen.js/dist/lg-fullscreen.min.js">
    <link href="../../../public/assets/vendor/lg-zoom.js/dist/lg-zoom.min.js">
    <link href="../../../public/assets/vendor/lg-video.js/dist/lg-video.min.js">
    <link href="../../../public/assets/vendor/lg-thumbnail.js/dist/lg-thumbnail.min.js">


    <!-- Main Theme Script -->
    <link href="../../../public/assets/js/theme.min.js">
    
  <head>
    <meta charset="utf-8">
    <title>Silicon | About v.2</title>
    ...
    <link rel="stylesheet" media="screen" href="../../../public/assets/vendor/swiper/swiper-bundle.min.css"/>
    <link rel="stylesheet" media="screen" href="../../../public/assets//vendor/lightgallery.js/dist/css/lightgallery.min.css"/>
    ...
    <!-- Page loading styles -->
      ...
      <div class="jarallax d-none d-md-block" data-jarallax data-speed="0.4">
        ...
        <div class="jarallax-img" style="background-image: url(assets/img/about/cover02.jpg);"></div>
