    ...
    <div class="card shadow-sm">
      <div class="row">
        <div class="col-md-12 pe-0">
          <div class="card-body border-right border-bottom p-3 h-100">
            ...
            <div class="d-flex flex-row bd-highlight pt-2">
              <table class="table table-striped">
                ...
                <tbody>
                  <tr v-for="item in calendarios.data" :key="item.id">
                    <td>
                      <Link
                        :href="route('calendario.edit', item.id)"
                        class="d-flex text-decoration-none text-reset"
                        >{{ item.convocatorias.nombre }}</Link
                      >
                    </td>
                    <td>
                      <Link
          ...
          />
            <pagination :links="calendarios.links" :total="calendarios.total" />
...
export default {
  ...
  setup(props) {
    const thereAreResults = computed(() => props.calendarios.total > 0);
